              ...
              >
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1.5">
                    <span className={`badge ${difficultyColors[selectedModule.difficulty_level as keyof typeof difficultyColors].bg} ${difficultyColors[selectedModule.difficulty_level as keyof typeof difficultyColors].text} text-xs`}>
