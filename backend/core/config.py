...
class Settings(BaseSettings):
    ...
    ENGINE_DEFAULT_RETRY_BUDGET_SECONDS: int = 60
    ENGINE_IDEMPOTENT_DEFAULT: bool = True
    ENGINE_CIRCUIT_BREAKER_FAILURE_THRESHOLD: int = 5
    ENGINE_CIRCUIT_BREAKER_RECOVERY_SECONDS: int = 30

    PARSING_ENGINE_TIMEOUT_SECONDS: int = 45
    PARSING_ENGINE_RETRY_ATTEMPTS: int = 3
    PARSING_ENGINE_RETRY_BUDGET_SECONDS: int = 90

    GAP_ENGINE_TIMEOUT_SECONDS: int = 30
    GAP_ENGINE_RETRY_ATTEMPTS: int = 2
    GAP_ENGINE_RETRY_BUDGET_SECONDS: int = 60

    PATH_ENGINE_TIMEOUT_SECONDS: int = 30
    PATH_ENGINE_RETRY_ATTEMPTS: int = 2
    PATH_ENGINE_RETRY_BUDGET_SECONDS: int = 60

    RAG_ENGINE_TIMEOUT_SECONDS: int = 45
    RAG_ENGINE_RETRY_ATTEMPTS: int = 2
    RAG_ENGINE_RETRY_BUDGET_SECONDS: int = 75

    EXPLAINABILITY_ENGINE_TIMEOUT_SECONDS: int = 30
    EXPLAINABILITY_ENGINE_RETRY_ATTEMPTS: int = 2
    EXPLAINABILITY_ENGINE_RETRY_BUDGET_SECONDS: int = 45
